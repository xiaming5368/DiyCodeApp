...
import com.android.diy.app.databinding.ActivityWebBinding;
...
public class WebViewActivity extends BaseActivity<ActivityWebBinding> {
    ...
    protected void initView(@Nullable Bundle savedInstanceState) {
        ...
        intiWebView(mDataBinding.webView);
    ...
    public void onPause() {
        ...
        mDataBinding.webView.pauseTimers();
    }
    ...
    public void onResume() {
        ...
        mDataBinding.webView.resumeTimers();
    }
    ...
    WebViewClient webViewClient = new WebViewClient() {
        ...
        @Override public boolean shouldOverrideUrlLoading(WebView view, String url) {
            JLog.d("shouldOverrideUrlLoading: " + url);
            return super.shouldOverrideUrlLoading(view, url);
        }

        @Override public void onPageFinished(WebView view, String url) {
            super.onPageFinished(view, url);
            mDataBinding.appToolbar.toolbar.setTitle(view.getTitle());
        }
    };
    ...
    WebChromeClient webChromeClient = new WebChromeClient() {
        ...
        @Override public void onReceivedTitle(WebView view, String title) {
            ...
            mDataBinding.appToolbar.toolbar.setTitle(title);
        }
    ...
    @Override protected void onDestroy() {
        ...
        if (mDataBinding.webView != null) {
            ...
            ((ViewGroup) mDataBinding.webView.getParent()).removeView(mDataBinding.webView);
            mDataBinding.webView.loadUrl("about:blank");
            mDataBinding.webView.stopLoading();
            mDataBinding.webView.setWebChromeClient(null);
            mDataBinding.webView.setWebViewClient(null);
